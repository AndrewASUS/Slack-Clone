...
const CreateChannelModal = ({ onClose}) => {
    ...
    const fetchUsers = async () => {
      ...
      try {
        const response = await client.queryUsers(
          {id: {$ne: client.user.id}}, // $ne: Not equal to in MongoDB
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Convert channel name to lower case and replacing spaces ( ) with dash (-)
      const channelId = channelName
        ...
        if (channelType === "private") {
          ...
          channelData.visabilty = "private"
        } else {
          channelData.visabilty = "public"
